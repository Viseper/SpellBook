...
public final class SpellBook extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        //bookMeta.setDisplayName("The Book of Spells");
        ...
        BaseComponent[] page6 = new ComponentBuilder("Spell Name").color(ChatColor.DARK_RED).append("\n\nSample Text").color(ChatColor.RESET).append("\n\nActivate Spell").color(ChatColor.DARK_AQUA).event(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/summon minecraft:tnt")).create();
